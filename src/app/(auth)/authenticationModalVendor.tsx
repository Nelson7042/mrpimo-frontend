...
import RegisterFormVendor from "./(component)/RegisterFormVendor";
...
const AuthenticationModalVendor = ({ isOpen, close }: ModalProps) => {
      ...
      <div>
        <div className="py-4 flex justify-between mb-[16px] md:mb-[24px] lg-[40px] ">
          <h3 className="text-[14px] flex-1   md:text-[20px] md:leading-[24px]  text-gray-700 font-semibold">
            Log in or Create a Vendor Account to Continue
          </h3>
...
export default AuthenticationModalVendor;

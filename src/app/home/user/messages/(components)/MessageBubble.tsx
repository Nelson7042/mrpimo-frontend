            ...
            {isEditing ? (
              <div className="flex flex-col gap-2 py-1">
                <textarea
                  ...
                  className="text-sm bg-black/5 rounded p-1.5 text-gray-900 resize-none outline-none min-h-[36px]"
                  autoFocus
              ...
              <>
                <p className="text-[14px] text-gray-900 break-words leading-[19px]">
                  {displayText}

...
export default function BuyerDisputesPage() {
  ...
  const fetchDisputes = async () => {
    ...
    try {
      ...
      const data: any = await disputeService.getMyDisputes(params);
    ...
    <div>
      <div className="max-w-screen-xl py-2">
        ...
        <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900">My Disputes</h1>
            ...
            {disputes.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500">
                  {activeTab === "all" ? "You haven't raised any disputes yet." : `No ${activeTab} disputes found.`}
                </p>
              </div>
            ) : (
              disputes.map((dispute: any) => (
                <div
                  ...
                  onClick={() => router.push(`/home/user/disputes/${dispute._id}`)}
                >
                  {/* Mobile Card */}
